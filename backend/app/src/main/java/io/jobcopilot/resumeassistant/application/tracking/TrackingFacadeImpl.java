package io.jobcopilot.resumeassistant.application.tracking;
...
import io.jobcopilot.resumeassistant.api.tracking.dto.response.TrackingEventResponse;
...
import io.jobcopilot.resumeassistant.api.tracking.facade.TrackingFacade;
...
import io.jobcopilot.resumeassistant.application.tracking.service.TrackingApplicationService;
import io.jobcopilot.resumeassistant.application.tracking.service.TrackingStatsService;
...
public class TrackingFacadeImpl implements TrackingFacade {
    ...
    private JobResponse mapJobToResponse(final io.jobcopilot.resumeassistant.domain.job.entity.Job job) {
