...
import io.jobcopilot.resumeassistant.infrastructure.cache.listener.DynamicConfigListener;
...
public class RedisConfig {
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(
        ...
        container.addMessageListener(dynamicConfigListener, new ChannelTopic("config:changed"));
        return container;
    }
}
