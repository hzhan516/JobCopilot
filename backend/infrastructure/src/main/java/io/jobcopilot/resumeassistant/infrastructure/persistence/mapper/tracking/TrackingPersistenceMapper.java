package io.jobcopilot.resumeassistant.infrastructure.persistence.mapper.tracking;

import io.jobcopilot.resumeassistant.domain.tracking.entity.ApplicationTracking;
import io.jobcopilot.resumeassistant.domain.tracking.entity.TrackingEvent;
import io.jobcopilot.resumeassistant.infrastructure.persistence.entity.tracking.ApplicationTrackingJpaEntity;
import io.jobcopilot.resumeassistant.infrastructure.persistence.entity.tracking.TrackingEventJpaEntity;
