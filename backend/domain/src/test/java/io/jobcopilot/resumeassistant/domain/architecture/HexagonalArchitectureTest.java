package io.jobcopilot.resumeassistant.domain.architecture;
...
class HexagonalArchitectureTest {
    ...
    static void setUp() {
        domainClasses = new ClassFileImporter()
                .importPackages("io.jobcopilot.resumeassistant.domain");
    }
    ...
    void domainShouldBeFreeOfCycles() {
        SlicesRuleDefinition.slices()
                .matching("io.jobcopilot.resumeassistant.domain.(*)..")
                .should()
                .beFreeOfCycles()
                .check(domainClasses);
    }
