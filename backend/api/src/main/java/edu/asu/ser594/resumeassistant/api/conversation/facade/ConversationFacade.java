...
public interface ConversationFacade {
     ...
     * Send a message
     */
    ConversationResponse sendMessage(String conversationId, SendMessageRequest request, String userId);
     ...
     * Close conversation
     */
    void closeConversation(String conversationId, String userId);
