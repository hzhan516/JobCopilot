...
class InternalApiClient:
    ...
    def get_baseline_features(self) -> list[dict[str, Any]]:
        try:
            url = f"{self.base_url}/api/internal/ai/baseline-features"
            with httpx.Client(timeout=BACKEND_QUERY_TIMEOUT * 10) as client:
    ...
    async def get_baseline_features_async(self) -> list[dict[str, Any]]:
        try:
            url = f"{self.base_url}/api/internal/ai/baseline-features"
