...
def _make_command(file_url="https://example.com/resume.pdf", file_type="pdf") -> ResumeParseCommand:
...
def test_process_resume_success(mock_download, mock_extract, mock_parse):
    ...
    mock_parse.return_value = {"name": "Alice", "email": "alice@example.com", "skills": ["Python"], "experience": []}
...
@patch("app.services.resume_orchestrator.extract_resume_text")
@patch("app.services.resume_orchestrator.download_file_bytes")
def test_process_resume_with_different_file_type(mock_download, mock_extract, mock_parse):
    ...
    mock_parse.return_value = {"name": "Bob", "email": "bob@example.com", "skills": [], "experience": []}

    process_resume(_make_command(file_url="https://example.com/resume.docx", file_type="docx"))
...
def test_process_resume_event_data_shape(mock_download, mock_extract, mock_parse):
    ...
    mock_parse.return_value = {"name": "Charlie", "email": "charlie@example.com", "skills": ["Go"], "experience": []}
