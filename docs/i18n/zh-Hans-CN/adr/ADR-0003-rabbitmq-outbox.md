...
> [English](../../../adr/ADR-0003-rabbitmq-outbox.md) | [简体中文](ADR-0003-rabbitmq-outbox.md) | [繁體中文](../../zh-Hant-TW/adr/ADR-0003-rabbitmq-outbox.md)
...
JobCopilot 存在大量 **异步处理场景**，需要可靠的消息传递机制：
