...
**智慧求職助手**是一個 AI 驅動的平台，面向應屆畢業生和轉職者。它解析上傳的履歷，透過語義向量匹配評估與就業市場資料的契合度，並提供互動式 AI 助手迭代改進履歷內容。安全的檔案管理、非同步 AI 處理和個人化推薦幫助使用者節省時間、提高面試率。
...
本專案為亞利桑那州立大學（JobCopilot Open Source, JobCopilot 課程）學術目的開發。
