...
> [English](../../../../api/backend/response-format.md) | [简体中文](../../../zh-Hans-CN/api/backend/response-format.md) | [繁體中文](response-format.md)
...
JobCopilot API 採用統一的回應格式，無論請求成功或失敗，都會回傳以下結構：
